...
export const teamMembers: TeamMember[] = [
  {
    ...
    position: 'チーフデザイナー',
    positionEn: 'CDO',
    bio: '大学では醸造を学んでいて、個人でiOSアプリの開発もしている変な人。人とは違う視点からのデザインを実装していくことを目指す。',
  ...
  },
  {
    ...
    position: '代表',
    positionEn: 'CEO',
    bio: '大学では情報を学びLLMの研究を大学院で行う。開発を主導し、アイディアだしから実装まで監督する。面白いと思うことだけをするをモットーにし、このチームを立ち上げる。',
  ...
  },
  {
    ...
    position: 'お金関係',
    positionEn: 'CAO',
    bio: '大学時代は法学部。会計士を目指し会計の勉強中。このチームを一番俯瞰的に観察しコントロールできる人材。人里離れた場所での生活を望んでいる。',
