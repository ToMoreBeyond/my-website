...
export const products: Product[] = [
  {
    ...
    name: '忠嵩',
    nameEn: 'TADATAKA',
    tagline: '移動がそのまま日記になるiOSライフログアプリ',
    description: '自分の日記が自分の人生の歴史になる。GPS/BLE/加速度センサーによる高精度な移動記録で、毎日の足跡を美しい地図として残します。',
  ...
  },
  {
    ...
    name: 'TOI-RUN',
    nameEn: 'TOIRUN',
    tagline: 'アプリを開いた時に、どこにトイレがあるのかすぐわかるiOSアプリ',
    description: 'すぐにわかるのが重要！お腹が痛い時に一番近いトイレを方位磁針的に案内する緊急時対応アプリです。',
  ...
  },
  {
    ...
    tagline: '集合場所を決めるアプリ',
    description: '都会の人向けの待ち合わせ場所決定アプリ。お金の平等・時間の平等を考慮して、最適な集合場所を提案します。',
