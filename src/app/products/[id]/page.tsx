      ...
      <section className="pt-24 pb-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          <motion.div
            ...
            animate={{
              background: [
                `radial-gradient(circle at 20% 50%, ${product.id === 'tadataka' ? 'rgba(34, 197, 94, 0.1)' : product.id === 'toirun' ? 'rgba(59, 130, 246, 0.1)' : 'rgba(139, 92, 246, 0.1)'} 0%, transparent 50%)`,
                `radial-gradient(circle at 80% 50%, ${product.id === 'tadataka' ? 'rgba(34, 197, 94, 0.1)' : product.id === 'toirun' ? 'rgba(59, 130, 246, 0.1)' : 'rgba(139, 92, 246, 0.1)'} 0%, transparent 50%)`,
                `radial-gradient(circle at 20% 50%, ${product.id === 'tadataka' ? 'rgba(34, 197, 94, 0.1)' : product.id === 'toirun' ? 'rgba(59, 130, 246, 0.1)' : 'rgba(139, 92, 246, 0.1)'} 0%, transparent 50%)`,
              ],
            }}
            transition={{
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.h1 
                ...
                style={{
                  background: `linear-gradient(135deg, #fff 0%, ${product.id === 'tadataka' ? '#22c55e' : product.id === 'toirun' ? '#3b82f6' : '#8b5cf6'} 50%, #fff 100%)`,
